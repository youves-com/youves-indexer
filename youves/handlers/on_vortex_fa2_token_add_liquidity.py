...
async def on_vortex_fa2_token_add_liquidity(
    _ctx: HandlerContext, add_liquidity
) -> None:
    ...
    await models.Trade.create(
        ...
        token_1_pool=Decimal(add_liquidity.storage.xtzPool),
        token_2_pool=Decimal(add_liquidity.storage.tokenPool),
        token_2_address=add_liquidity.storage.tokenAddress,
    )

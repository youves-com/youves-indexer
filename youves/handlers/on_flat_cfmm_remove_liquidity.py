...
async def on_flat_cfmm_remove_liquidity(_ctx: HandlerContext, remove_liquidity) -> None:
    ...
    await models.Trade.create(
        ...
        token_1_pool=Decimal(remove_liquidity.storage.tokenPool),
        token_2_pool=Decimal(remove_liquidity.storage.cashPool),
        token_1_address=remove_liquidity.storage.tokenAddress,
        token_2_address=remove_liquidity.storage.cashAddress,
    )
